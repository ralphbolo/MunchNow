...
temp.reviews.create(:menu_item_id => 72,:review => " North and navy My boyfriend and I recently had dinner at North & Navy and it blew us away. Since we work in the restaurant industry, we are all about sharing dishes and trying as much of a menu as possible, and North & Navy's menu did not disappoint. If you are looking for light Italian food that avoids excessive amounts of tomato and garlic (I don't think there was tomato in any of the dishes we ordered!), this is the place for you.It's a pretty good place to be considering the fact that it's situated in in a quiet neighborhood, away from the main street in little Italy.", :rating => 5.0, :totalbill => 30.5, :title => "Great Northern Italian Cuisine!", :restaurant_id => 12)
temp.reviews.create(:menu_item_id => 55,:review => " Clover Enjoyed a great evening with friends at North and Navy. The atmosphere was lively, the food was different and delicious and the service was perfect.The place is actually a small convenience store that's also a residence, but it's nevertheless charming. The menu board was difficult to read and looking at all of the other customers, it would seem that nearly everyone here is a regular and won't need it.", :rating => 4.0, :totalbill => 30.5, :title => "Past could have been better", :restaurant_id => 10)
temp.reviews.create(:menu_item_id => 49,:review => "The soca kitchen and pub What a great addition to the food scene in downtown Ottawa! Went for lunch with 2 ladies from work. The food was fantastic, lovely wine list.despite the number of combos they offered, in the end you can customize it yourself.", :rating => 5.0, :totalbill => 302.5, :title => "Mama Mia", :restaurant_id => 9)
temp.reviews.create(:menu_item_id => 42,:review => "El camino Oh and we went to North & Navy for our seventh dating anniversary at the end of February and I have been meaning to write a full-blown review but haven’t had time. When I first walked in I was hapily greeted by one of the workers behind the counter ", :rating => 3.0, :totalbill => 3.5, :title => "Luigi tho", :restaurant_id => 8)
temp.reviews.create(:menu_item_id => 36,:review => "The smoque shack A group of us decided to check out the old Beckta location to try the new northern Italian fare of North and Navy. Each of the four of us had primi - the citrus salad, the tortellini, the smelt and the endive salad, secondi - turkey and polenta, octopus, liver and mackerel; and dessert.My experience at North and Navy in Ottawa was an eye-opener. Northern Italy is a cuisine that I'm not very familiar. After dining at North and Navy it was a pleasant first impression", :rating => 3.0, :totalbill => 33.5, :title => "In b4 mario comes in", :restaurant_id => 7)
temp.reviews.create(:menu_item_id => 31,:review => "MlT DWN The cashier was also extremely nice as well Great evening enjoying tasty food with my best friends, favorites included the smelts, the smoked ricotta appetizer, the flatiron steak and creamy polenta. The cappuccino and tiramisu ended the evening beautifully.", :rating => 3.0, :totalbill => 34.5, :title => "8 inch sndwich for $5", :restaurant_id => 6)
temp.reviews.create(:menu_item_id => 25,:review => "CACOA 70 The sandwich itself was, first off, a big meal for such a cheap price Great meal. Pork belly & cucumber salad was delicious. Risotto also very good. Will definitely be going back.", :rating => 5.0, :totalbill => 36.5, :title => "Price increase", :restaurant_id => 5)
temp.reviews.create(:menu_item_id => 19,:review => "Big Smoke Burger The albion room Personally it's not my cup of tea The pasta is perfectly cooked al dente. I tried the tortellini and the bigoli.", :rating => 3.0, :totalbill => 33.5, :title => "Best wings too!", :restaurant_id => 4)
temp.reviews.create(:menu_item_id => 13,:review => "The albion room Obviously one of the best in the city...I made a reservation online for my wife and I. We ordered both a mystery appetizer and meal. We also left the wine pairing decision to our server", :rating => 2.0, :totalbill => 12.5, :title => "Prosciutto-licious", :restaurant_id => 3)
temp.reviews.create(:menu_item_id => 7,:review => "fraser cafeMy go-to place for consistently great Italian-style deli sandwiches", :rating => 1.0, :totalbill => 42.5, :title => "The best", :restaurant_id => 2)
temp.reviews.create(:menu_item_id => 1,:review => "Wellington gastro pub Much wow", :rating => 2.0, :totalbill => 50.5, :title => "Beautiful Italian Food", :restaurant_id => 1)
...
# Ratings from this user
temp.reviews.create(:menu_item_id => 71,:review => "North and navy Had this tonight as their blind order app, and it was melt in your mouth amazing Went to Whalesbone (take-out location) today as my friend mentioned they have a special (affordable) lunchtime menu", :rating => 4.0, :totalbill => 50.0, :title => "Overpriced mediocrity. Stop drinking the coolaid", :restaurant_id => 12)
temp.reviews.create(:menu_item_id => 64,:review => "Fauna Chicken and Waffles - ZERO taste, like air. This could have been because the amazing sauce from the scallops was still lingering, as we had the scallops first.So yesterday was tax day", :rating => 4.5, :totalbill => 40.0, :title => "Hefty prices but oh so good", :restaurant_id => 11)
temp.reviews.create(:menu_item_id => 58,:review => "Clover Definitely one of Ottawa's finest restaurants. Everything we ordered was superb, lovely wine list and great service. Thought fish would be good for the brain", :rating => 4.5, :totalbill => 60.0, :title => "I kick myself if I don't get the brown-bag lunch at least once a week", :restaurant_id => 10)
temp.reviews.create(:menu_item_id => 52,:review => "The soca kitchen and pub Perfectly crispy on the outside, moist in the middle...served on a waffle with maple syrup. Even better than I had in Texas.In the past, we have also enjoyed the smoked fish sandwiches, which are lighter, and super flavourful.", :rating => 3.5, :totalbill => 50.0, :title => "Mobile review", :restaurant_id => 9)
temp.reviews.create(:menu_item_id => 46,:review => "El camino Had a Birthday celebration here with impeccable service. Not only do I have common food allergies, but my grandmother and sister only eat very select items.Well the Whalesbone Oyster House is my fav", :rating => 2.5, :totalbill => 20.0, :title => "Large catch of the day!", :restaurant_id => 8)
temp.reviews.create(:menu_item_id => 40,:review => "The smoque shack Everything you see on this dish was simply delicious! The smoked duck in the middle, to the fois gras in the bottom right, and finally, the crab cake (not super certain) was so yummy.La couleur un peu tristounette de la chaudrée ", :rating => 1.5, :totalbill => 34.0, :title => "Best fish supply in Ottawa!", :restaurant_id => 7)
temp.reviews.create(:menu_item_id => 34,:review => "MLT DWN Listen, Monday night is Tapas night, and apparantly small plates make it such that the computers can no longer separate checks. The food was amazing.", :rating => 4.5, :totalbill => 21.0, :title => "My favourite lunch in the city", :restaurant_id => 6)
temp.reviews.create(:menu_item_id => 28,:review => "CACAO 70 I've heard wonders about Allium, and my husband and I love food so we decided to check it out. Well the first thing that caught my eye was the surprise menu. had a 3 oyster sandwich ($12), a reg chowder ($5).", :rating => 2.5, :totalbill => 80.0, :title => "Yummy lunch spot!", :restaurant_id => 5)
temp.reviews.create(:menu_item_id => 22,:review => "Big smoke burger I've been wanting to try Allium for a while now, having read copious amounts of positive reviews. Went there last Thursday and Allium lived up to the hypeAbsolutely wonderful food! Highly recommend the duck for main course. Save room for dessert, the Banoffie Pie is deliciousMy philosophy is good food at a reasonable price.", :rating => 4.5, :totalbill => 21.0, :title => "Yummy fish sandwiches", :restaurant_id => 4)
temp.reviews.create(:menu_item_id => 16,:review => "The albion room We went to Allium for a week night romantic dinner. We shared the crab toast and I had the flat iron steak with foie gras, while my spouse had the surprise main. The crab toast was delicious and fresh, the steak was cooked rare, as requested and very tasty but it was a little hard to cutMy boyfriend and I recently had dinner and it blew us away", :rating => 4.5, :totalbill => 12.0, :title => "Whalesbone sammich bag", :restaurant_id => 3)
temp.reviews.create(:menu_item_id => 10,:review => "Fraser Cafe The accompanying fries with spiced mayo were simply perfect. The surprise meal was a pork chop and was very well presented and tasty. I would highly recommend this place for a nice meal in a casual ambiance with friends. The best part of the experience was the service which was simply impeccable, effective and friendly.The atmosphere was lively, the food was different and delicious and the service was perfect.", :rating => 4.1, :totalbill => 88.0, :title => "Ottawa Magazine!", :restaurant_id => 2)
temp.reviews.create(:menu_item_id => 4,:review => "Wellington gastropub Went for Taste for Life last week and loved it! First time but won't be our last! People at our table ordered and loved: halibut, scallops, hangar steak and the green salad is to die for!What a great addition to the food scene in downtown Ottawa!", :rating => 4.5, :totalbill => 66.0, :title => "Best best best lunch in town", :restaurant_id => 1)
...
# Ratings from this user
temp.reviews.create(:menu_item_id => 67,:review => "North and Navy I have been a customer since 2007. I went to the new location on February 27th. I was very disappointed. The originality or what made Beckta special is gone. The young lad coming around with a variety of breads to choose from was a Beckta original. The cheese selection was a big plus. The very detailed description of the cheeses available made you look forward to tasting the cheese. Now you are given a list of cheeses to choose from. These two things which made Beckta original are now gone. I don't know if the staff even realize that they are in the service industry.", :rating => 4.0, :totalbill => 190.0, :title => "Atmosphere...", :restaurant_id => 12)
temp.reviews.create(:menu_item_id => 60,:review => "fauna like the new location but disappointed with the prix fixe menu. I prefer a 2 course meal and not fond of the limited choices and the 3 courses. Food is excellent of course, but I would prefer all options. Our service ( on a Thursday) was particularly slow compared to high end TO restaurants The appetizers were exceptional", :rating => 2.0, :totalbill => 9.0, :title => "Watt overprice", :restaurant_id => 11)
temp.reviews.create(:menu_item_id => 54,:review => "Clover My family and I went to Beckta for a special occasion and they really made us feel special. The service was courteous and well synchronised. The wine pairings were great and ideal with our meal selections. Great food with beautiful presentation. Overall, lovely dining experience for anyone looking for delicious food with a nice ambience.. 2 of us ordered the seared scallops and 2 ordered the mussels", :rating => 2.0, :totalbill => 23.0, :title => "Tofu Burger", :restaurant_id => 10)
temp.reviews.create(:menu_item_id => 49,:review => "The Soca Kitchen and Pub Another example of why Ottawa is no longer the sleepy town it once was. Chef's, Artists, Architects and musicians are no longer saying I just want to be cool for Ottawa they are just simply being cool. Soon the rest of the world will take notice. Ottawa is finally finding its own place/character and individuals like Beckta are contributing to that. Well done! I waited for 5min at the bar before the super polite waitress asked me, is there something I can get you?", :rating => 3.0, :totalbill => 45.0, :title => "Great food, great atmosphere", :restaurant_id => 9)
temp.reviews.create(:menu_item_id => 43,:review => "El Camino This is the best service I have ever had, ANYWHERE. The food was so good, I wanted to cry tears of glorious joy. The server suggested an unoaked chardonnay (Catena chardonnay) to go with our dish...and it was sooo good. Everything was excellent. The server also had perfect manners. EXCELLENT. This is now my top choice for late night drinks in the Market", :rating => 4.0, :totalbill => 67.0, :title => "Mr. Lew's Great Burger Search", :restaurant_id => 8)
temp.reviews.create(:menu_item_id => 37,:review => "The Smoque Shack A few girlfriends and I met up for a catch up dinner at Beckta. I've been to Play (sister restaurant of Beckta) in the past and to be honest it didn't hit the mark. The food at Play felt too farm-to-table simplistic but at least the ingredients tasted fresh. As a result, my expectations for Beckta were mixed. I was curious and excited that the restaurant had moved to a new location on Elgin but I was hesitant that the food would be similar to Play. To my surprise, Beckta was completely different. The restaurant was very spacious and the atmosphere was calm and relaxing Family of four. Two teenagers, two adults. We were there on a busy night.", :rating => 4.5, :totalbill => 12.0, :title => "Om Nom Nom International", :restaurant_id => 7)
temp.reviews.create(:menu_item_id => 31,:review => "MLT DWN Wow! An amazing night! The server was very attentive and helpful. The beef was cooked to perfection and the smores dessert was to die for. They really went above and beyond with all of the little extras. I can't wait to go back at the new location. Thank you. :) It used to be good, but the burger today was sooo dry", :rating => 4.5, :totalbill => 80.0, :title => "Great spot, avoid peak hours", :restaurant_id => 6)
temp.reviews.create(:menu_item_id => 25,:review => "Cacao70 My wife and I have been to Beckta 4 times over several years, the latest being dinner on Apr.11/2014 Each time the quality of the food has been superb and the service level continues to improve. Regardless of your tastes, you will not be disappointed. Wine list by the glass is varied and emphasizes many Canadian wines which is nice. We don't get to Ottawa often but when we do, Beckta is always on our to-do list! my favourite place in town & has been for quite some time", :rating => 4.5, :totalbill => 43.0, :title => "good food, good embiance, good price", :restaurant_id => 5)
temp.reviews.create(:menu_item_id => 19,:review => "Big Smoke Burger I take anyone visiting Ottawa to Bekta and no one was ever disappointed. Amazing food and wine selection with an exceeding expectations service right from the door to the end of the dinner.Très bon menu du jour avec un saumon grillé.", :rating => 4.5, :totalbill => 21.0, :title => "Worth the WAIT!", :restaurant_id => 4)
temp.reviews.create(:menu_item_id => 13,:review => "The Albion Room The evening’s adventure began with hamachi sashimi with a nori vinaigrette and ponzu paired with Champagne Brut “Cuvé Saint Flavy” Georges Gardet, France N.V. The hamachi (also known as Japanese Yellowtail or amberjack) simply melted in your mouth and the nori (edible seaweed) vinaigrette complimented the dish perfectly with the champagneabsolutely fantastic burger.", :rating => 2.0, :totalbill => 45.0, :title => "salad dressing is crack cocaine.", :restaurant_id => 3)
temp.reviews.create(:menu_item_id => 7,:review => "Fraser Cafe I was really excited to eat here, it was on my to eat list after all. I had taken a look at their menu the day before and couldn't decide what to get, so I made an executive call and went with the 8 course tasting menu. Why not? Then I'd be trying a little of everything right? Of course rightBeen there a million times.", :rating => 4.5, :totalbill => 55.0, :title => "Has potentil", :restaurant_id => 2)
temp.reviews.create(:menu_item_id => 1,:review => "Wellington GastroPub When I assess the quality of a restaurant, i generally take into account a multitude of factors. For the most part, restaurants focus on food, and really, that is all that matters to me. After all, without good food, there really is very little reason to Full Review Burgers are amazing & good fries, everything else stinks but if you want their burgers, I suggest take out", :rating => 4.0, :totalbill => 33.0, :title => "Highlight of Byward Market", :restaurant_id => 1)
...
temp.locations.create(phone_number: '613 543 1234',
	manager: 'Mike Jones',:address => "1325 Wellington Street West", :opentime => "11:30", :closetime => "21:30")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 123 1234',
	manager: 'Adam Kal', :address => "7 Springfield Road", :opentime => "11:30", :closetime => "22:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 123 1234',
	manager: 'Ali word',:address => "33 Nicholas Street", :opentime => "11:30", :closetime => "22:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 600 1234',
	manager: 'Am tall',:address => "50 Rideau Street", :opentime => "10:30", :closetime => "21:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 123 3212',
	manager: 'haya sawr',:address => "53 William Street", :opentime => "10:00", :closetime => "23:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 213 3212',
	manager: 'Fata fsda',:address => "50 Rideau Street", :opentime => "10:00", :closetime => "22:00")
temp.locations.create(phone_number: '613 123 6565',
	manager: 'Solja Ink',:address => "292 Princess Street", :opentime => "10:00", :closetime => "22:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 654 6458',
	manager: 'Mike Nguy',:address => "129 York Street", :opentime => "11:30", :closetime => "23:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 432 5745',
	manager: 'Don Ming',:address => "380 Elgin St.", :opentime => "12:00", :closetime => "22:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 543 8234',
	manager: 'swer la',:address => "93 Holland Avenue", :opentime => "11:30", :closetime => "22:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 463 1432',
	manager: 'In Li',:address => "155 Bank St", :opentime => "11:00", :closetime => "21:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 1432 4134',
	manager: 'Guy Homme',:address => "425 Bank St", :opentime => "11:30", :closetime => "22:00")
...
# Locations for restaurant
temp.locations.create(phone_number: '613 532 4234',
	manager: 'Mang Guy',:address => "226 Nepean St", :opentime => "11:00", :closetime => "22:00")
